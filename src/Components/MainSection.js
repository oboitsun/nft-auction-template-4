  ...
  render() {
    ...
    return (
      <div
        ...
        className={` w-full h-full flex flex-col rounded-3xl relative`}>
        {editMode && (
          <div
            className={`edit absolute top-0 left-0 h-full w-full ${hover} rounded-2xl z-20`}></div>
        )}
        ...
        <div className='h-[75px] flex justify-end items-end 2xl:px-20 xl:px-16 lg:px-10 px-2 py-3 z-10'>
          <Favorites />
        </div>
        <section className='horizontal-ratio w-full flex flex-grow  z-10'>
          <iframe
        ...
        <div className='h-60 py-2 lg:py-3 2xl:py-7 pl-3 lg:pl-6 2xl:pl-12 pr-3 xl:pr-4 2xl:pr-8  overflow-hidden  z-10'>
          <Details />
        </div>
      </div>
    )
